...
export function CertificatePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <header className="border-b border-gray-200 bg-white px-4 py-4 shadow-sm dark:border-gray-700 dark:bg-gray-900 md:px-6 print:hidden">
      ...
      <main className="mx-auto max-w-4xl px-4 py-10 md:px-6">
        <div className="rounded-2xl border-4 border-blue-200 bg-white p-8 text-center shadow-lg dark:border-blue-900 dark:bg-gray-900 md:p-16">
          <div className="mx-auto inline-flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 text-3xl text-blue-600 dark:bg-blue-900 dark:text-blue-300 md:h-20 md:w-20">
            🎓
          </div>

          <h1 className="mt-6 text-3xl font-extrabold text-gray-900 dark:text-gray-100 md:text-5xl">
            Teilnahmezertifikat
          </h1>
            ...
            <div className="mt-8">
              ...
              <div className="mt-3 flex flex-wrap justify-center gap-3">
                {unlockedBadges.map((badge) => (
                  <span
                    key={badge}
                    className="rounded-full border border-yellow-300 bg-yellow-100 px-4 py-2 text-sm font-medium text-yellow-800 dark:border-yellow-700 dark:bg-yellow-900 dark:text-yellow-200"
                  >
                    🏅 {badge}
                  </span>
                ))}
