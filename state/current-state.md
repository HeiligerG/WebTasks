...
[🔄] Phase 4: Sandbox, Live-Preview & Sicherheit  ← AKTIV
...
**Detaillierte Planung:** _Noch zu erstellen: `state/phases/04_phase-sandbox.md`_

**Aktueller Stand in Phase 4:**

- [ ] Iframe-Sandbox mit `srcdoc` konzipieren
- [ ] Compiler/Assembler für HTML/CSS/JS-Fragmente implementieren
- [ ] Debounce-Mechanismus für Live-Preview einbauen
- [ ] `postMessage`-Interceptor für Konsole implementieren
- [ ] AST-basierte Infinite-Loop-Protection einbauen
- [ ] Simulierte Konsole in der Host-App visualisieren
