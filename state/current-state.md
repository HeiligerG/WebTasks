...
[🔄] Phase 6: UI/UX, Navigation & State-Persistenz  ← AKTIV
...
**Detaillierte Planung:** _Noch zu erstellen: `state/phases/06_phase-ui.md`_

**Aktueller Stand in Phase 6:**

- [ ] Startseite mit Hero-Sektion und Bundle-Kacheln implementieren
- [ ] Bundle-Kacheln mit Status-Indikatoren (gesperrt/in Bearbeitung/abgeschlossen) versehen
- [ ] Dreispaltiges Split-Pane-Layout für `TaskPage` finalisieren (Instruktion | Editor | Preview/Konsole)
- [ ] Markdown-Renderer für Aufgabenstellungen integrieren
- [ ] Routing zwischen Startseite und Aufgaben verfeinern
- [ ] Zustandspersistenz via `localStorage` implementieren
