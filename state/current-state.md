...
[🔄] Phase 8: Curriculum-Content & End-to-End-Integration  ← AKTIV
...
**Detaillierte Planung:** _Noch zu erstellen: `state/phases/08_phase-curriculum.md`_

**Aktueller Stand in Phase 8:**

- [ ] Bundle 2 (JavaScript Grundlagen) als JSON erstellen
- [ ] Bundle 3 (Interaktive Web-Applikationen) als JSON erstellen
- [ ] Alle Validation-Tests für die neuen Bundles definieren
- [ ] End-to-End-Walkthrough durchführen und korrigieren
...
| `src/components/BadgeDisplay.tsx`           | Badge-Anzeige-Komponente                                   |
| `src/components/CertificatePage.tsx`        | Zertifikatsseite mit Druckfunktion                         |
...
| `src/components/InstructionPanel.tsx`       | Linke Spalte mit Markdown-Instruktion und Konfetti-Trigger |
...
| `src/lib/confetti.ts`                       | Konfetti-Trigger-Funktionen                                |
...
| `src/stores/appStore.ts`                    | Globaler Zustand mit `localStorage`-Persistenz und Badges  |
